...
class Program
{
    ...
    static void Display(List<Employee_Model> employees)
    {
    ...
    static int SearchByIdLiner(List<Employee_Model> employees,int target)
    {
    ...
    static int SearchByIdBinary(List<Employee_Model> employees, int target)
    {
        int low = 0;
    ...
    static int SearchByName(List<Employee_Model> employees ,string name)
    {
        for(int i=0;i<employees.Count;i++)
        {
    ...
    static void SearchByDepName(List<Employee_Model> employees,string Dname)
    {
        bool found= false;
    ...
    static void SearchByExperience(List<Employee_Model> employees, int experience)
    {
        bool found = false;
    ...
    static void SearchBySalary(List<Employee_Model> employees, double salary)
    {
        bool found = false;
